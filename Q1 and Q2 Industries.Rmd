...
investments <- readRDS("kaggle_data_cleaned.rds")
...
``` {r, echo = T}
summary(aov(rounds ~ market, data=d))
...
#Plot the average funding amounts for each market
ggplot(funding_per_round, aes(x = market, y = funding_per_round)) + geom_bar(stat="identity", fill="lightblue") + coord_flip() + labs(title = "Average Number of Rounds by Industry", x = "", y = "")
```
