...
Next, we confirm some of the data. All the funds data adds up to the total, but venture money and round money do not perfectly align. 
...
round_total <- apply(roundData, 1, sum)
diff <- data$venture - round_total
