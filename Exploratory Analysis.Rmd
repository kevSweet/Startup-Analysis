...
```{r}
# Import
data <- read.csv("investments_VC.csv")
...
Next, we confirm some of the data. All the funds data adds up to the total, but venture money and round money do not perfectly align. It appears that in most cases, the sum of round totals addds up to be the venture funding, but sometimes round data is missing or see data is included. A new round_total variable is create.
